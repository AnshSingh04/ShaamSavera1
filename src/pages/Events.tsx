...
const allEvents: Event[] = [
  ...
  {
    id: 4,
    title: "Senior Fitness Club",
    description: "Low-impact exercises designed specifically for seniors. Improve strength, balance, and flexibility in a supportive environment.",
    date: "April 25, 2024",
  ...
  },
  {
    ...
    description: "Express your creativity through painting and handicrafts. All materials provided. No experience necessary!",
    date: "April 28, 2024",
  ...
  },
  {
    ...
    description: "Help tend to our community garden while learning about sustainable gardening practices. Light refreshments provided.",
    date: "May 2, 2024",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Discover all the wonderful activities and events designed for our vibrant senior community
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {allEvents.map((event) => (
            <div
              key={event.id}
              className="group backdrop-blur-md bg-white/85 rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden"
            >
              {/* Event Image */}
              ...
              <div className="p-8">
                {/* Category Badge */}
                <span className="inline-block px-4 py-2 bg-orange-400 text-white text-lg font-medium rounded-full mb-4">
                  {event.category}
                </span>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center text-gray-600">
                    <Calendar className="h-6 w-6 text-orange-400 mr-4 flex-shrink-0" />
                    <span className="text-lg font-medium">{event.date}</span>
                  </div>
                  <div className="flex items-center text-gray-600">
                    <Clock className="h-6 w-6 text-orange-400 mr-4 flex-shrink-0" />
                    <span className="text-lg">{event.time}</span>
                  </div>
                  <div className="flex items-center text-gray-600">
                    <MapPin className="h-6 w-6 text-orange-400 mr-4 flex-shrink-0" />
                    <span className="text-lg">{event.location}</span>
                  </div>
                  <div className="flex items-center text-gray-600">
                    <Users className="h-6 w-6 text-orange-400 mr-4 flex-shrink-0" />
                ...
                <button
                  ...
                  className="w-full py-4 px-6 text-xl font-semibold text-white bg-orange-400 hover:bg-orange-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                  Sign Up for Event
                </button>
              </div>
